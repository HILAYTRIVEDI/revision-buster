...
class Assets {
    ...
    public function __construct() {
        add_action( 'admin_enqueue_scripts', [ $this, 'rb_enqueue_scripts' ] );
        add_action( 'admin_enqueue_scripts', [ $this, 'rb_enqueue_styles' ] );
    }

    /**
     * Enqueue scripts and styles
     */
    public function rb_enqueue_scripts() {
     ...
     * Enqueue styles
     */
    public function rb_enqueue_styles() {
